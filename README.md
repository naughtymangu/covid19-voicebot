...
1. Create a file speech-to-text-eagi/service_account_file.json and save the access key to the Google Cloud API with Speech-To-Text API enabled in it.
...
2. Create a file src/service_account_file.json and save the access key to the Google Cloud API with Text-To-Speech API enabled in it.

3. Uruchom `docker-compose up`.
3. Run docker-compose up.

4. Połącz się klientem SIP na udp localhost:5060 – username i password 6001.
4. Connect with SIP client to udp localhost:5060 – username i and password 6001.
